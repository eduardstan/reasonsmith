...
Raising this ceiling means changing the *system*: exposing an inference artefact the reasons can be
enumerated from. Nothing in the adapter can do it, and nothing in the adapter should try.
