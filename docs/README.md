...
| [`adapters/`](adapters/) | The three adapter files `three-systems.md` walks through (`neural_scorer.py`, `probabilistic_scorer.py`, `symbolic_rules.py`): complete, runnable systems, each on its own with `python docs/adapters/<name>.py`. |
