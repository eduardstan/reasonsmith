...
- [`../notebooks/`](../notebooks/) — runnable demonstrations ([reader index](../notebooks/README.md)): [quickstart reason deletion](../notebooks/01_quickstart_reason_deletion.ipynb), [three systems and three rungs](../notebooks/02_three_systems_three_rungs.ipynb), [bring your own pack and engine](../notebooks/03_bring_your_own_pack_engine.ipynb), [one system across US and EU jurisdictions](../notebooks/04_one_system_two_jurisdictions.ipynb), and [from clause to formula](../notebooks/05_from_clause_to_formula.ipynb).
