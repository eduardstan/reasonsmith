...
Three sharp duties have executable, lawyer-readable gold challenge sets under
[`autoformalization.md`](autoformalization.md) and `src/reasonsmith/challenges/`. They are a deliberately small starting subset: the two ECOA/GDPR
logical properties and the EU AI Act record property have crisp boundaries and concrete near-misses;
open-textured, relational, certificate and temporal duties are not silently approximated here. The
