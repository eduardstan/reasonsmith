...
*fields* of a requirement. This document is the record of the *judgement*: for each of the 27 shipped
...
- **Presence is not adequacy.** Twenty-one of the twenty-seven shipped duties are `record` duties: a
