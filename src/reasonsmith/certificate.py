...
What this module is for:
  ...
  Deletion probe mechanism, in two passes:
    ...
    and met no fact of it. `docs/theory/07-explanation.md` is the definition,
    with the lemmas and the
...
class Certificate:
    ...
    #: for deletion and there was nothing for it to resolve. `docs/theory/07-explanation.md` §7.6
...
def _resolve_jointly(
    ...
    Three outcomes per candidate, and `docs/theory/07-explanation.md` §7.4
    ...
    # greater than one (`docs/theory/07-explanation.md` §7.3, Corollary 7.11),
    # so it is not searched over.
