...
What a reader must not break:
  ...
  - The joint-deletion search's probes are counted into `trials` and whether it *finished* is
    ...
    (`docs/theory/07-explanation.md` §7.6), so how far it got is not a curiosity
    about performance — it
    ...
    def evaluate(
        ...
        budget = {
            ...
            "input_space": {
                ...
                # The joint search's own two numbers. `docs/theory/07-explanation.md` §7.6:
                # a partial
