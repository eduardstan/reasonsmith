...
- `python -m reasonsmith.demo`, run twice: **910 lines**, byte-identical, `md5sum` `3c1c2245dc86191199fdccc8b0144b28`. This is the transcript committed in [`docs/example-output.md`](docs/example-output.md), and the pair of numbers `tests/test_docs_example_output.py` checks that file's header against.
